...
<head>
  ...
  <style>
    ...
    .form-section, .product-card { background-color: #fff; border-radius: 15px; box-shadow: 0 4px 10px rgba(0,0,0,0.1); padding: 20px; }
...
<div class="container py-5">
  <h2 class="mb-4 text-center">🛒 Admin - Manage Products</h2>
